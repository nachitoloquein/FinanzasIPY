...
use App\Http\Controllers\pagoProveedoresController;
>>>>>>> Stashed changes
/*
|--------------------------------------------------------------------------
| Web Routes
...
Route::get('/pagoProveedores',[pagoProveedoresController::class,'index']);
Route::get('/pagoProveedores/{iddoc}',[pagoProveedoresController::class,'index']);
